...
public class ThreadPoolWorkFlowExecutor {
    ...
    public ThreadPoolWorkFlowExecutor(WorkFlowContext context) {
        this.context = context;
        observer = null;
        initThreadPool();
    }

    public ThreadPoolWorkFlowExecutor(WorkFlowContext context, WorkFlowExecutorObserver observer) {
        this.context = context;
...
*/
    ...
    private void executeEnabledWorkflows() throws ResourceException {
        ...
        try {
            ...
            String[] workflowClasses = context.getWorkFlowConfig().getJobs();
            ...
            if (workflowClasses != null) {
                ...
                for (String workflowClassNameSubType : workflowClasses) {
                    ...
                    int maxWorkflows = context.getWorkFlowConfig()
                            .getMaxWorkflowsPerFire(getWorkflowClassNameWithoutPackage(workflowClassName));
                    int maxSeconds = context.getWorkFlowConfig()
                    ...
                    do {
                        ...
                        workflows = context.getWorkFlowManager().pick(workflowClassName, subType, maxCount);
                        if (workflows != null) {
    ...
    private void executeSingleWorkflow(WorkFlow<Object> workflow) {
        ...
        try {
            ...
            context.getWorkFlowManager().execute(workflow);
...
/*
            ...
            if ((mo != null) && (mo.endTime - mo.startTime > 120000)) {
                log.warn("WorkflowJob detected slow execution, details:\n" + mo.toString());
            }
            ErrorDiagnostics.clear();
*/
